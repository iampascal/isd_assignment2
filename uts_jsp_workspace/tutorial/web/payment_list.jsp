...
<body>
  <div class="payment-container">
    ...
    <%
        ...
        ArrayList<PaymentList> paymentLists = manager.fectPayments();
    %>
    <h1>Payment List</h1>
    
    <form action="FindPayment" method="post">
        <input type="text" id="paymentIdFilter" placeholder="Search by Payment ID" name="paymentIdFilter">
